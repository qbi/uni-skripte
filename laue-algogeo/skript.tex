...
Punkte $p_1,\dotsc, p_n \in \R^d$ heißen affin abhängig, wenn es $\alpha_1,\dotsc, \alpha_n \in \mathbb R$ gibt, so dass gilt:
...
\begin{defini}[Konvexkombination]
 Sei $p_{1},\dotsc, p_{n} \in \mathbb R^d$, dann heißt 
...
\begin{thrm}[Helly] 
Seien $C_{1}, \dotsc, C_{n} \in \mathbb R^d$ konvexe Teilmengen und $n \geq d + 1$.
