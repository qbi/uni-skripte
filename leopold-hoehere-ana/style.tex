...
% von einer Zeile (parskip) und dafür keinen Absatzeinzug,
...
% Farbanpassung für verweise etc
\usepackage{color}
...
\DeclareMathOperator{\support}{supp} % Support / Träger einer Funktion \supp{f} -> supp(f)
