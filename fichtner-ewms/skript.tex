...
\begin{remark}
  \begin{enumerate}
    \setcounter{enumi}{-1}
  \item Schreibweisen: $\int_A fd\mu\colon=\int f\chi_Ad\mu, \nu\ll\mu$
...
\begin{beispiel}
  Sei $\Omega=\N_0, \CF=\FP(\N_0),\mu\colon=\sum_{i=1}^\infty \delta_i$.\\
...
\begin{remark}
  ...
  \item["`$\Rightarrow$"'] Angenommen $\neg f=_\mu g$,
    ...
    die erste Gleichung und sei $A_n\colon=\{\omega\in\Omega|f(\omega)\geq
    ...
    n_0\colon \mu(A_{n_0})>0=\mu(\{f(\omega)\geq g(\omega)+\frac{1}{n_0}\})=
...
\item Auswahl \emph{mit} Berücksichtigung der Reihenfolge und
  ...
  $A_{k,m}^{oWmR}\colon=\{[\omega_1,\ldots,\omega_k]| \{\omega_1,\ldots,
...
\begin{align*}
  ...
  \CF =\FP(\Omega)\qquad P(A)\colon=\frac{\# A}{\# \Omega}\\
...
\begin{satz}[Poissonsche Grenzwertsatz]
  Sei $(p_n)_{n=1}^\infty$ eine Folge mit $0\leq p\leq 1$ für alle
