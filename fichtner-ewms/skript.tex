...
{\itshape
  ...
  \begin{itemize}
   ...
   \item \href{mailto:mario-ullrich@gmx.de}{Mario Ullrich} (2007)
  \end{itemize}
}
...
\begin{beispiel}
  ...
  auf Probleme sto"sen. So ist im Beispiel der Genetik
...
\begin{proof}
  ...
  das Integral monoton ist, folgt $E\xi= \int\xi(\omega)P(d\omega)$ monoton $=
