...
\item $P_{\xi_i}=B_{1,p}=\nicefrac{1}{2}(\delta_1+\delta_0)$ mit
  ...
  D\xi_i=\nicefrac{1}{2} (1-\nicefrac{1}{2})=\nicefrac{1}{4}$
\item $\lvert\sum_{i=1}^{250} \xi_i-125\rvert \geq 2=\colon A$ entspricht der
...
\begin{remark}
  Andere Formulierung:\\
   Wenn zu jeder Teilfolge eine Teilfolge existiert, so dass man immer
...
\begin{remark}
  Betrachten Zufallsgrößen mit $E\abs{\xi}^{p}<+\infty$  und führt hier eine
