...
\begin{proof}
  ...
  \item
    ...
    \item["`$\Leftarrow$"'] Setzen $\{b_1,\ldots,b_n\}=\{f(\omega)|
      \omega\in\Omega\}$ und $B_i=\fmineins(\{b_i\})$ für $i=1,\dotsc,n$.
      Damit folgt
...
\begin{beispiel}
  \begin{enumerate}
  \item Sei $\mu=\delta_{\omega_0}\Rightarrow f=g\ \mu"~\text{fast-überall}\Leftrightarrow
    f(\omega_0)=g(\omega_0)$ für $\omega_{0}\in\Omega$.
