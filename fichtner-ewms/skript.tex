% TODO
% This document ist work in progress. I expect it to be stable at the
% end of August 2005
%
...
\item Auswahl \emph{mit} Berücksichtigung der Reihenfolge und
  ...
  Menge der Auwahlen: $A_{k,n}^{mWmR}:= \{[\omega_1,\ldots, \omega_k]|
...
\item Auswahl \emph{mit} Berücksichtigung der Reihenfolge und
  ...
  \omega_k\}\in \{1,\ldots,n\}\}=m(n-1)(n-2)\ldots (n-k+1)=
  \frac{n!}{(n-k)!}$
