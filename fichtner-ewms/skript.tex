...
\begin{proof}
  ...
  \item Sei $f$ messbar und gelte $f=f^{+}-f^{-}$. Wir wissen nach der
    ...
    \begin{align*}
      ...
      \int f^{-}\,d\mu &= \int_{i\in I} \alpha_{i} f^{-}(\omega_{i})
    \end{align*}
    Weiterhin wissen wir, dass $f$  genau dann $\mu$-integrierbar ist, dann
    ist dass $\int\abs{f}\,d\mu<ß\infty$. Damit sind auch die Integrale der
    beiden Teilfunktionen kleiner als unendlich.
    Wenn $f$ $\mu$-integrierbar ist, dann folgt aus der Definition
    dritter Stufe: $\int f\,d\mu=\int f^+-(-f^-)d\mu=\sum_{i\in I}
