...
\begin{beispiel}
  \begin{enumerate}[(1)]
  \item Nullmaß\index{Nullmaß} $\CO: \CO(A)=0\,(a\in\CF)$
  ...
  \item Sei $\Omega$ abzählbar und $\CF=\FP(\Omega)$. Dann ist das
    Zählmaß\index{Zählmaß} $\mu(A):=\#(A)$ die Anzahl der
...
\begin{definition}
  ...
  Wahrscheinlichkeitsmaß\index{Wahrscheinlichkeitsmaß}, wenn
  gilt: \[P(\Omega)=1\]
