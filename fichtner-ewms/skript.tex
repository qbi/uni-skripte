...
\begin{proof}
  \begin{enumerate}[1. F{a}ll]
  \item Sei $f\colon\sup f_i$. Dann ist $f$ eine Abbildungen von $\Omega$
  ...
  \item $f\colon=\inf f_1\Rightarrow f\colon\Omega\rightarrow\R$. Wegen
...
\begin{satz}[Übertragungssatz]
  ...
  messbarer Raum, $h\colon[\Omega_1,\CF_1]\rightarrow[\Omega_2,\CF_2],
...
\begin{definition}
  ...
  \item Sei $Q=\sum_{i=1}^\infty q_i \delta_i$ ($Q$ ist bezüglich des
    ...
    \[r_Q(i) \colon= \frac{q_i}{\sum_{j=i}^\infty} \qquad i=1,2, \ldots\]
