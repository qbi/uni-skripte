...
echo "<u1>direkte SVN-Unterstützung im Explorer (geht nicht in der Uni)</u1>
<p><ol>
   ...
   klicken. \"SVN Checkout\" wählen und folgende Angaben machen:
   ...
   SKRIPT aus der obigen Liste auswählen (und in der URL ersetzen),
   z.B. hecker-parallel
   Beispiel:
...
<p>Du hast Änderungen gemacht und willst diese veröffentlichen?
...
http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html</a>
   ...
   SKRIPT aus der obigen Liste auswählen (und statt SKRIPT einsetzen),
   z.B. hecker-parallel
   Beispiel:
