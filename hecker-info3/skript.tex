...
\begin{align*}
  O(g(n)) &\coloneqq \{ f(n) | \exists c_2 > 0, n_0 \in \mathbb{N}\ \forall_n^\infty\colon  0\leq f(n)\leq c_2\,g(n)\}\\
  \Omega(g(n)) &\coloneqq \{ f(n) | \exists{}c_1 > 0, n_0 \in\mathbb{N}\ \forall_n^\infty\colon  0\leq c_1\,g(n)\leq f(n) 
    \} \\
