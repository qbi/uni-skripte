...
\highl{Brute-Force-Algorithmus}, der mittels erschöpfenden Probierens zu
...
Zu diesem Zweck definiert man eine Menge mit endlich vielen \highl{event
...
\begin{definition}[Unterstützte Operationen]
  ...
  $\log(n)$ Teilschritte und somit proportional $\log(n)$
