...
\textit{Algorithmen} und \textit{Daten"-struk"-turen}. Sie gehören zusammen
...
alle vertikalen schnei"-den, und die Hälfte der Kanten verläuft
...
überabzählbar viele Prüf"-pun"-kte und das Verfahren wäre nicht maschinell
...
sei als zusätzliche Übungsaufgabe über"-lassen. Dazu ist jedoch ein dynamischer
...
\begin{definition}[Abstrakter Datentyp (ADT)]
  Eine Datenstruktur, zusammen mit den von ihr unter"-stützten Operationen, 
  heißt ab"-strakter Datentyp (ADT).
\end{definition}
