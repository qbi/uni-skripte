...
Des Weiteren gilt die folgende Regel:
...
\begin{definition}
  $a(i<j) \coloneqq \lbrace (a_1, \dots , a_n \vert a_i \in S \wedge
  a_i < a_j \rbrace $
\end{definition}
...
sind. An den Kanten steht entweder "`$j$"' oder "`$n$"'. Ein kleines
Beispiel ist in \autoref{271003c} zu sehen.
