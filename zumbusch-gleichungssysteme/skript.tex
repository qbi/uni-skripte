...
\documentclass[halfparskip,pointednumbers,twoside,openright,smallheadings,headsepline]{scrreprt}
\usepackage[ngerman]{babel}
\usepackage[T1]{fontenc}
\usepackage[latin1]{inputenc}
\usepackage{amsmath,amsthm,amssymb,xspace,url,svn,color,fixmath,pifont,booktabs,tikz,scrpage2}
