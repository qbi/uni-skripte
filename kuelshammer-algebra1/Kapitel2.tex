...
\begin{enumerate}[(i)]
  ...
  \item \begin{itemize}
  	\item["`$\Rightarrow$"'] Sei $ab \equiv ac\pmod m$, d.\,h. $m\mid ab - ac$, etwa $a(b - c) = mz$ für ein $z \in \Z$. Dann $\frac{a}{d}(b - c) = \frac{m}{d}z$ mit $d := \ggt(a, m)$. Wegen $\ggt(\frac{a}{d}, \frac{m}{d}) = 1$ folgt aus (i): \[\frac{m}{d}\mid b - c \text{, d.\,h. } b \equiv c\pmod{\frac{m}{d}}\]
...
\begin{itemize}
	...
	\item["`$\Leftarrow$"'] Sei $d\mid b, a_0 := \frac{a}{d}, m_0 := \frac{m}{d}, b_0 := \frac{b}{d}$. Wegen $\ggt(a_0, m_0) = 	1$ existiert $y_0, z_0 \in \Z$ mit $1 = a_0y_0 + m_0z_0$. Daher: $b = \underbrace{a_0b}_{= ab_0}y_0 + \underbrace{m_0b}_{= 	mb_0}z_0 \equiv ax_0\pmod{m}$ mit $x_0 = b_0y_0 (\Rightarrow \text{ Existenz einer Lösung})$\\
	Für $x \in \Z$ gilt: 
	\[\begin{array}{lcl}
