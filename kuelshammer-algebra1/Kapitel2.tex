...
Eine \addindex{"Aquivalenzrelation}{Äquivalenzrelation} auf einer Menge $M$ ist eine Relation der Form $\left(M,M,R\right)$ mit folgenden Eigenschaften:
\begin{enumerate}[(i)]
...
%%%%%%%%%%%%%%%%%%%
\begin{defi}
Seien $a, b \in \Z, m \in \N$ mit $m\mid a - b$. Dann nennt man $a$ kongruent zu $b$ \addindex{Modulo}{modulo} $m$ und schreibt $a \equiv b\pmod m$.
\end{defi}
...
die Restklassen von $a$ modulo $m$. $\left( \text{z.B.: ist } 2 + 6\Z = \left\{\ldots, -10, -4, 2, 8, 14, \ldots\right\}\right)$ Die Bezeichnung "`\addindex{}{Restklasse}"' erklärt sich folgendermaßen: Division mit Rest liefert $q, r \in \Z$ mit $a = qm + r$ und $0 \leq r < m$. Wegen $m\mid qm = a - r$ ist dann $a \equiv r\pmod m$, d.h. $a + m\Z = r + m\Z$.\\ 
...
Ein $k \in \N_0$ mit $a_1\mid k, \ldots, a_n\mid k$ heißt \addindex{Kleinstes gemeinsames Vielfaches}{kleinstes gemeinsames Vielfaches(kgV)} von $a_1, \ldots, a_n$, wenn $k\mid m$ für alle $m \in \Z$ mit $a_1\mid m, \ldots, a_n\mid m$ gilt.
\end{defi}
