...
Setzt man $\varphi\psi = \left(c_0, c_1, c_2, \ldots\right)$ mit $c_0 = a_0b_0$, $c_1 = a_0b_1 + a_1b_0, \ldots, c_i := \sum\limits_{j + k = i}a_jb_k, \ldots$, so wird $P$ zu einem kommutativen Ring (\highl{Polynomring}) mit $r\left(\varphi\psi\right) = \left(r\varphi\right)\psi = \varphi\left(r\psi\right)$ für $r \in K, \ \varphi, \psi \in P$.\\
