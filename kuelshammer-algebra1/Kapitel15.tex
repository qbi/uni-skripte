...
Eine \highl{Gruppe!Operation}{Operation (action)}\index{Operation} einer Gruppe $G$ auf eine Menge $\Omega$ ist eine Abbildung $G\times\Omega\mapsto\Omega$, $(g,\alpha)\mapsto {}^g\alpha$, mit den folgenden Eigenschaften:
...
\[{}^g\alpha\coloneqq(\tau(g))(\alpha) \qquad \text{ für } g\in G,\alpha\in\Omega\]
...
\[{}^g\alpha\coloneqq g(\alpha) \qquad \text{ für } g\in G, \alpha\in\Omega.\]
...
$G_\alpha$ heißt \highl{Gruppe!Stabilisator}{Stabilisator}\index{Stabilisator} von $\alpha$ in $G$.
\end{defi}
