...
\begin{definition}
  ...
  $\K=\C$}. Eine Funktion $||\cdot||:E\rightarrow [0,\infty[$ heißt
...
\begin{remark}
  Durch den Ansatz $d(x,y):=||x-y||$ wird auf $E$ eine
  ...
  Räume. z.B.: $(x_n)\subset E$ konvergiert in $E: \exists x\in E \,
  \forall \varepsilon>0 \, \exists n_\varepsilon\in \N \, \forall
  n>n_\varepsilon:||x_n-x||\leq \varepsilon$
\end{remark}
...
\begin{beispiel}
  ...
  \item
    ...
    \item Normierter Raum der beschränkten Funktionen auf einer Menge
      ...
      $B(\Omega):=\{f:\Omega\rightarrow\R|f\text{ beschränkt}\},
    ...
    \item Sei $[X,d]$ ein metrischer Raum. Normierter Raum der 
      beschränkt stetigen Funktionen auf $X:[C_b(X),||\cdot||_\infty],
      C_b(X):=\{f:X\rightarrow\R|f \text{ beschränkt stetig}\}$
    \end{enumerate}
  ...
  \item Normierter Raum der $\RR$-integrierbaren Funktionen:
    $[\RR[a,b],||\cdot||_\infty], \RR[a,b]=\{f:[a,b]
    \rightarrow\R|f\text{ Riemann-integrierbar}\}, ||f||_\infty:=
    \sup_ {x\in I}|f(x)|$
  \item $[C^1[a,b],||\cdot||_\infty], C^1[a,b]:=\{f\in C[a,b]|f 
...
\begin{proof}: Vollständigkeit von $[C_b(X),||\cdot||_\infty]$:\\
  ...
  \item Existenz des Limes\\
    ...
    \exists n_\varepsilon \in \N \, \forall n,m \geq n_\varepsilon :
  ...
  \item Beschränkheit von $f$:\\
    $\forall x\in X \, \forall m\geq n\geq n_\varepsilon : |f_n(x)-f_m(x)|
    \leq\varepsilon\xrightarrow{m\rightarrow\infty}\forall x\in X
    \, \forall n\geq n_\varepsilon : |f_n(x)-f(x)|\leq\varepsilon
  ...
  \item Stetigkeit von $f$:\\
    ...
    $\exists\delta_\varepsilon>0 \, \forall x\in X: d(x,x_0)\leq
  ...
  ist:\\
  Sei $(f_n)\subset\RR[a,b]:f_n\rightarrow f\in B[a,b] (||f_n-f||_\infty
  \rightarrow 0)$. zu zeigen: $f\in\RR [a,b]$:\\
  Sei $\varepsilon >0$. Für $\eta:=\frac{\varepsilon}{4(b-a)}$ wählen
  wir $n_0\in\N:||f_n-f||_\infty=\sup_{x\in[a,b]} |f_{n_0}(x)-f(x)|
  \leq \eta\Leftrightarrow \forall x\in[a,b]:-\eta-f_{n_0}(x)\leq f(x)
  ...
  \begin{align*}
    ...
    \frac{\varepsilon}{2}
  \end{align*}
  $f_{n_0}\in\RR[a,b]\Rightarrow\exists\ZZ_\varepsilon:\overline{S}
...
\begin{remark}
  ...
  n_\varepsilon:||f_n-f||_\infty =\sup_x |f_n(x)-f(x)|\leq\varepsilon
  \Leftrightarrow$
  \[\forall\varepsilon>0\,\exists n_\varepsilon\in\N\,\forall n\geq
  n_\varepsilon\,\forall x: |f_n(x)-f(x)|\leq\varepsilon\] Im
...
\begin{proof}
  ...
  n_\varepsilon:||f_n-f||_\infty\leq\varepsilon$
  \begin{align*}
...
\item Der Satz \ref{satz:gleichKonvInt} gilt nicht für punktweise Konvergenz.
  \begin{beispiel}
    $f_n:[0,1]\rightarrow\R,f_n(x):=\max\{n-n^2|x-\frac{1}{n}|;0\}=
    \begin{cases}
...
\item Satz \ref{satz:gleichKonvInt} gilt nicht für uneigentliche Integrale
  ...
  Beispiel: $f_n:[0,\infty[\rightarrow\R,f_n(x):=\frac{x}{n^2}e^{-\frac{x}{n}},
...
\begin{theorem}
  Seien $f_n:[a,b]\rightarrow\R$ stetig differenzierbar und $f_n
  \rightarrow f:[a,b]\rightarrow\R$ punktweise konvergent.
...
\begin{remark}
  ...
  \item $f_n:[-N,N]\rightarrow\R\quad f_n(x)=\frac{1}{n}\sin (nx)$
...
\begin{definition}
  ...
  \exists \alpha_1,\dots,\alpha_m\in\K: x=\sum_{i=1}^{m} \alpha_ix_i\]
\end{definition}
\[\dim E :=\inf\{m| \exists x_1,\dots,x_m\in E\, \forall x\in A\,
\exists \alpha_1,\dots,\alpha_m\in\K:x=\sum_{i=1}^m\alpha_ix_i\}\]
Beispiel: $\R^n, \C^n$
...
\begin{proof}
  ...
  \begin{enumerate}
    ...
    \item Sei $K$ abgeschlossen und beschränkt, d.h.
      \begin{enumerate}
      \item $\exists M\geq 0\, \forall x\in\K:||x||_\infty\leq M$
      \item $\forall (x_n)\subset K: x_n\xrightarrow{||\cdot||}
  ...
  $(\xi_1^{(n_k)})\subset(\xi_1^{(n)}):\xi_1^{(n_k)}
  ...
  $(\xi_2^{(n_k)_l}):(\xi_2^{(n_k)_l})\rightarrow \xi_2\in\R$. Damit
...
\begin{definition}
  ...
  wenn 
  \[\exists c_0,c>0\,\forall x\in E: ||x||_0\leq c_0||x||\qquad
  ||x||\leq c||x||_0\]
\end{definition}
...
\begin{proof}
  ...
  $||x||_0:=\sum_{i=1}^n|\alpha_i|=||\alpha||_1$ mit $\alpha=
  ...
  folgende Funktion: $f:[\R^n,||\cdot||_\infty]\rightarrow\R,
  f(\alpha_1, \dots,\alpha_n):=||\sum_{i=1}^n \alpha_i x_i||$. Es
  ...
  $g(\alpha_1,\dots,\alpha_n):=\sum_{i=1}^n|\alpha_i|, g:
...
\begin{proof}
  ...
  $||x_0||:=\max_{1\leq i\leq n}|\alpha_i|=||\alpha||_\infty,\alpha=
  (\alpha_1,\dots,\alpha_n)\in\R^n$ ist eine Norm auf $E$. Nach Satz
  \ref{satz:VRNorm} existieren $c, C>0:c||x||_0\leq ||x||\leq C||x||_0$.
  \begin{enumerate}[(i)]
  \item Sei $x_k=\sum_{i=1}^n \alpha_i^{(k)} y_i, \alpha_i^{(k)}=
    ...
    $\alpha =)\alpha_1,\dots,\alpha_n)\in\R^n:||\alpha^{(k)}
  ...
  \item
    ...
    \item["`$\Leftarrow$"'] Definieren $f:[\R^n, ||\cdot||_\infty]
      \rightarrow E, f(\alpha_1,\dots,\alpha_n):=\sum_{i=1}^n
      ...
      \{(\alpha_1,\dots,\alpha_n)\in\R^n:\sum_{i=1}^n \alpha_iy_i
...
\begin{definition}
  Seien $E,F$ Vektorräume über $\K$. Eine Abbildung $A:E\rightarrow F$
  heißt \emph{linear\index{Abbildung!lineare}}, genau dann wenn:
  \[\forall \alpha,\beta\in\K\,\forall x,y\in E: A(\alpha x+\beta y)=
  \alpha Ax+\beta Ay\]
\end{definition}
...
\begin{definition}
  Seien $E,F$ normierte Räume. Eine lineare Abbildung $A:E\rightarrow F$
  heißt beschränkt, genau dann wenn:
  \[\exists M\geq 0 \, \forall x\in E: ||Ax||_F \leq M||x||_E\]
\end{definition}

Es gilt: $\LL(E,F):=\{A:E\rightarrow F| A\text{ beschränkt}\}$ ist ein
Vektorraum. Durch $||A||:=\sup_{||x||_E\leq 1} ||Ax||_F$ wird auf $\LL(E,F)$
eine Norm (Operatorennorm\index{Operatorennorm}) erklärt.
$[\LL(E,F),||\cdot||]$ ist ein normierter Raum.\\
Ferner gilt: $\forall x\in E:||Ax||_F\leq ||A||\cdot ||x||_E$. Für
$x\neq 0:\left.
\begin{array}{rcl}
  ||A(\frac{x}{||x||})|| & \leq & ||A||\\
...
\begin{theorem}
  ...
  lineare Abbildung $A:E\rightarrow F$ stetig (=beschränkt).
\end{theorem}
\begin{proof}
  Sei $n:=\dim E$. Wählen Basis $x_1,\dots,x_n\in E$.
...
Setzt man $\tilde{r}(h):=\begin{cases}
...
\begin{definition}
  Seien $E,F$ Banachräume und $f:D\rightarrow F, D\subset E$ offen, 
...
\begin{beispiel}
  $E,F$ sind Banachräume und $f:E\rightarrow F, f(x)=c+Ax, c\in F,
  A\in\LL (E,F)$ Dann $f'(x)=A$\\
  Beweis: $f(x+h)=c+A(x+h)=c+Ax+Ah=f(x)+Ah, r(h)=0\Rightarrow f'(x)=A$
\end{beispiel}

\begin{remark}
  Seien $E,F$ Banachräume und $f:D\subset E\rightarrow F$ in $D$
  differenzierbar.  Dann ist $f'$ eine Abbildung von $D$ in $\LL(E,F),
  f':D\rightarrow \LL(E,F)$, d.h. die Bilder sind beschränkte lineare
  Operatoren.
...
\begin{enumerate}[(i)]
\item Seien $E,F$ Banachräume und $f,g:D\rightarrow F, D\subset E$ offen
  und differenzierbar in $x\in D$. Dann $f+g,\alpha\cdot f, \alpha\in\R$
  mind. in $x$ differenzierbar und es gilt: $(f+g)'(x)=f'(x)+g'(x),
  (\alpha f)'(x)=\alpha f'(x)$
\item Sei $E$ ein Banachraum, $f,g:D\rightarrow\R, D\subset E$ offen, in
...
\item Kettenregel: Seien $E,F,G$ Banachräume, $f:D\rightarrow F$, in $x$
  differenzierbar, $g:\tilde{D}\rightarrow G, \tilde{D\subset F}$ offen
...
\begin{definition}
  ...
  $f:D\rightarrow E, D\subset E$ offen, im Punkt $x\in E$ der Grenzwert
  \[\frac{\partial f}{\partial h}(x):=\lim_{\stackrel{t\rightarrow 0}{t\in\R}} \frac{f(x+th)-f(x)}{t}\],
  so heißt $\frac{\partial f}{\partial h}(x)$ \emph{Richtungsableitung\index{Richtungsableitung}} von $f$ in $x$.
\end{definition}

\begin{theorem}
  Seien $E,F$ Banachräume und $f:D\rightarrow F, D\subset F$ offen, in 
...
\begin{theorem}
  \label{satz:richtAbl}
  Seien $E,F$ Banachräume, $f:D\rightarrow F, D\subset E$ offen, in $x$
...
\begin{definition}
  Sei $D\subset \R^n$ offen und $f:D\rightarrow \R$ eine reelle Funktion.
  ...
  $\frac{\partial t}{\partial x_i}(x):=\frac{\partial f}{\partial e_i}(x)$
  \emph{partielle Ableitung\index{Ableitung!partielle}} von $f$ nach der
  $i$-ten Koordinate.
\end{definition}

Bemerkung: Die partielle Ableitung einer Funktion $f:D\rightarrow\R,D
...
Beispiel: \[f(x_1,x_2)=x_1^2+x_1\sin x_2 \quad f:\R^2\rightarrow \R\]
\[\frac{\partial f}{\partial x_1}=2x+\sin x_2 \quad \frac{\partial f}{\partial x_2}=x_1\cos x_2\]

Die Existenz der partiellen Ableitung von $f:D\rightarrow \R, D\subset\R^n$
...
\begin{theorem}
  ...
  Sei $D\subset\R$ offen und $f:D\rightarrow\R^m,f=\begin{pmatrix}
    f_1\\\vdots\\f_m\end{pmatrix}$ und $f_i:D\rightarrow\R$ im Punkt
  ...
  $i=1,\dots,m$\\
  $h=te_j$ mit $e_j=(0,\dots,1,\dots,0): f_i(x+te_j)=f_i(x)+
...
\begin{theorem}
  ...
  \end{pmatrix}
  :D\rightarrow\R^m, f_i:D\rightarrow\R$ eine Funktion, so dass die
  ...
  \end{pmatrix}:D\rightarrow\R^m, D\subset\R^n$ offen, ist in $x\in D$
  differenzierbar, g.d.w. $f:D\rightarrow\R$ in $x\in D$ differenzierbar
  ist.\\
  Daher ist o.B.d.A. für $m=1$:\\
  $f:D\rightarrow\R$ Aus der Tatsache, dass $D$ offen ist, folgt, dass
  $\exists \delta>0 : \stackrel{\circ}{B}(x,\delta)=\{z\in\R^n:||x-z||_\infty
  <\delta\}\subset D$\\
  Sei $h\in \R^n, ||h||<\delta$. Setzen 
  \[z^{(i)}:=x+\sum_{k=1}^i h_ke_k \quad z^{(0)}:=x\]
  ...
  $\theta_i\in [0,1]:f(z^{(i)})-f(z^{(i-1)})=\frac{\partial f}{\partial x_i}
  (y^{(i)})h_i$, wobei $y^{(i)}=z^{(i-1)}+\vartheta_ih_ie_i$
  \begin{small}
    $\varphi (t):=f(z^{(i-1)}+the_j)\, \varphi(1)=f(z^{(i)})\,\varphi (0)
    =f(z^{(i-1)})$\\
    ...
    =\frac{f(z^{(i-1)}+(t_0+\zeta)h_ie_i)-\overbrace{f(z^{(i-1)}+t_0h_ie_i}^{=:y^{(i)}}}{\zeta}$\\
...
Die Existenz der partiellen Ableitungen von $f:D\subset\R^n
\rightarrow \R$ reicht i.a. \emph{nicht} für die Differenzierbarkeit von $f$!

\begin{definition}
  Sei $f:D\rightarrow \R, D\subset\R^n$ offen, eine reellwertige
...
\begin{theorem}
  Sei $f:D\rightarrow\R, D\subset\R^n$ offen, in $x\in D$ differenzierbar.
...
Für $h_0:=\frac{\text{grad}f(x)}{||\text{grad}f(x)||_2}$ gilt:\\
...
Sei $f:D\subset\R^n\rightarrow \R$ differenzierbar. $f(a+h)=f'(a)h+r(h),
...
$V:\R^2\rightarrow \R, V(l+\Delta l,h+\Delta h)\approx V(l,h)+V'(l,h)
...
\begin{alignat*}{2}
u &:D\subset\R^n\rightarrow\R^m\ & g &:M\subset\R^m\rightarrow\R\,u(D)\subset M\\
...
\begin{theorem}
  \label{satz:MWSreell}
  Sei $f:D\rightarrow \R, D\subset\R^n$ offen, auf $D$ differenzierbar,
  $x,x+h\in D$ mit $x+th\in D$ für $0\leq t\leq 1$. Dann 
  \[\exists 0<\vartheta<1:f(x+h)-f(x)=f'(x+\vartheta h)h\]
  \textbf{Beweis}: (Anwendung des eindimensionalen Mittelwertsatzes)
  $\varphi(t):=f(x+th), \varphi:[0,1]\rightarrow \R$ ist stetig 
  differenzierbar.\\
...
\begin{enumerate}[(i)]
  \item In der Version von Satz \ref{satz:MWSreell}
    ...
    Beispiel: $f:[0,2\pi]\rightarrow\R^2, f(t)=\begin{pmatrix}\cos t\\\sin t
    \end{pmatrix}$ Zu zeigen ist: $\not\exists 0<\vartheta<1:f(2\pi)-
...
\begin{definition}
  ...
  \end{pmatrix}: [a,b]\rightarrow \R^m$, wobei $f_i:[a,b]\rightarrow\R$
  riemannintegrierbar sind. Dann heißt
  \[\int_a^b f(t)dt:=\begin{pmatrix}\int_a^b
...
als:
\[\int_a^bA(t)dt:=\left(\int_a^b a_{ij}(t)dt\right)_{\stackrel{i=1,\dots,m}{j=1,\dots,n}},
A(t)=(a_{ij}(t))\]
Ferner: $\int_a^bA(t)hdt=\left(\int_a^bA(t)dt\right)h,
h\in\R^n,h=\text{konstant}$

\textbf{Hilfssatz}: Für jede stetige Funktion $f:[a,b]\rightarrow\R^n$
gilt:
\[\left|\left|\int_a^bf(t)dt\right|\right|_2\leq
\int_a^b||f(t)||_2dt\]
Diese Ungleichung gilt auch für jede beliebige Norm $||\cdot||$ auf
$\R^n$\\
Beweis: Sei $u:=\int_a^b f(t)dt\in\R^n$. Dann $||u||_2^2=
...
\begin{theorem}
  \label{satz:MWSint}
  Sei $f:D\rightarrow\R^m, D\subset \R^n$ offen, stetig differenzierbar
  ...
  Die Operatorennorm ist genauer $||f'(x+th):[\R^n,||\cdot||_2]
  \rightarrow[\R^m,||\cdot||_2]||$\\
  \textbf{Beweis}: $f:\begin{pmatrix}f_1\\\vdots\\f_m
  \end{pmatrix}, f_i:D\rightarrow\R$ stetig differenzierbar. Wir
  definieren $\varphi_i:[0,1]\rightarrow\R, i=1,\dots,m, \varphi_i(t):=
...
\begin{definition}
  \begin{enumerate}[(i)]
    \item Sei $E$ ein normierter Raum und $x_0,x_1,\dots,x_n\in E$. Dann
      heißt
      \[P=\bigcup_{i=1}^n \{(1-\Theta)x_{i-1}+\Theta x_i:0\leq \Theta\leq 1\}\]
...
\begin{theorem}
  Sei $f:D\rightarrow \R^m, D\subset\R^n$ offen und polygonzugzusammenhängend,
  ...
  in $D$ verlaufender Polygonzug durch $x_0,x_1,\dots,x_n:=x$.
...
Notation: Sei $f:D\rightarrow\R, D\subset\R^n$ offen, eine partiell
differenzierbare Funktion. Sind alle partiellen Ableitungen 
$\frac{\partial f}{\partial x_i}:D\rightarrow\R$ selbst wieder partiell
differenzierbar, so heißt $f$ zweimal differenzierbar. Man kann die
partiellen Ableitungen 2. Ordnung bilden:
\[\frac{\partial^2 f}{\partial x_j \partial x_i}:=\frac{\partial}{\partial x_j}
\left(\frac{\partial f}{\partial x_i}\right)\]
Allgemeiner definiert man durch Induktion folgendes:\\
$f:D\rightarrow\R, D\subset\R^n$ offen, heißt $(k+1)$-mal partiell
...
Eine Funktion $f:D\rightarrow\R,D\subset\R^n$ offen, heißt $k$ mal
...
\begin{theorem}[Satz von Schwartz über die Vertauschbarkeit der
  ...
  Sei $f:D\rightarrow\R,D\subset\R^n$ offen, zweimal stetig partiell
  ...
  $B_\varepsilon(\xi,\eta):=\{(\tilde{\xi},\tilde{\eta})\in\R^2:
  \max\{|\tilde{\xi}-\xi|,|\tilde{\eta}-\eta|\}<\varepsilon\}\subset D$.
  Damit: $(\xi+h,\eta+k)\in B_\varepsilon(\xi,\eta)$ für $|h|,|k|<
  \varepsilon$. Sei $0<|h|,|k|<\varepsilon$. Wir definieren $\varphi (x):=
  f(x,\eta+k)-f(x,\eta), \varphi:[\xi,\xi+h]\rightarrow\R, h>0$
  differenzierbar. Nach dem Mittelwertsatz: $\exists x_1\in]\xi,\xi+h[:
  \varphi(\xi+h)-\varphi(\xi)=h\varphi'(x_1)$.
  \begin{align*}
    F(h,k) & := & f(\xi+h,\eta+k)-f(\xi+h,\eta)-f(\xi,\eta+k)+f(\xi,\eta)\\
    ...
    & \Rightarrow & \exists y_1\in]\eta,\eta+k[:
  ...
  Darstellung von $F(h,k)$ mit der Funktion $\psi(y):=f(\xi+h,y)-f(\xi)$
  in der Form $F(h,k)=\psi(\eta+k)-\psi(\eta)$\\
  Analog erhält man dann wie oben
  $\exists x_2\in]\xi,\xi+h[\quad
  y_2\in]\eta,\eta+k[:F(h,k)=hk\frac{\partial^2 f}{\partial x \partial y}
  (x_2,y_2)$\\
...
\begin{Folg}
  Sei $f:D\rightarrow\R,D\subset\R^n$ offen, $k$ mal stetig differenzierbar.
  Dann gilt:
  \[\frac{\partial^k f}{\partial x_{i_k}\dots\partial x_{i_1}}(\xi)=
  \frac{\partial^k f}{\partial x_{i_{\pi(k)}}\dots x_{i_{\pi(1)}}}\]
  für jede Permutation $\pi:\{1,\dots,k\}\rightarrow\{1,\dots,k\}$\\
  Der Beweis erfolgt induktiv.
\end{Folg}

\paragraph{Taylorscher Satz} Notationen: $D\subset\R^n$ offen,\\ $C^m(D):=
\{f:D\rightarrow\R|f \text{ besitzt stetige partielle Ableitungen der
Ordnung }\leq m\}$\\
$m=0:C(D):=C^0(D)$

\begin{theorem}
  Sei $D\subset\R^n$ offen, $f\in C^{m+1}(D), (m\geq 0)$ und 
  $h:=\begin{pmatrix}h_1\\\vdots\\h_n
  \end{pmatrix}\in\R^n$.
  ...
  \begin{align*}
    ...
    \frac{\partial }{\partial x_n})^k f(\xi) & := & 
  ...
  \end{align*}
  \textbf{Beweis}: Der Beweis erfolgt für den Spezialfall $n=2:$
  ...
  \begin{align*}
    ...
    \frac{\partial}{\partial x_2}\right)^kf(\xi) & := & 
...
\end{pmatrix}, \varphi(t):=f(\xi+th)=f(\xi_1+th_1,\xi_2+th_2), \varphi:
...
$\varphi^{(k)}(t)=\sum_{j=0}^n \binom{k}{j} \frac{\partial^k f}{\partial x_2^{k-j} \partial x_1^j}
  ...
  t^{k+1}, 0<\Theta <1$\\
  Für $t=1: f(\xi+h)=\varphi(1)=sum_{k=0}^m \frac{\varphi^{(k)}(0)}{k!}
...
\begin{definition}
  Eine Funktion $f:D\subset \R^n\rightarrow\R$ besitzt in $x\in D$ ein
...
\begin{theorem}
  Sei $D\subset \R^n$ offen und $f:D\rightarrow\R$ eine partiell
...
\end{theorem}
\begin{proof}
  Wir definieren $\varphi_i(t):=f(x+te_i), i=1,\dots,n,
...
\begin{definition}
  ...
  wenn \[\forall x\in\R^n\backslash \{0\}: \langle Ax,x\rangle >0\]
  A heißt \emph{positiv semidefinit\index{semidefinit}}, genau dann wenn
  \[\forall x\in \R^n :\langle Ax,x\rangle \geq 0\]
  A heißt negativ definit, genau dann wenn $-A$ positiv definit.
  \[\Leftrightarrow \forall x\in\R^n\backslash \{0\}:\langle Ax,x\rangle <0\]
  A heißt \emph{indefinit\index{indefinit}}, genau dann wenn
  \[\exists x,y\in\R^n:\langle Ax,x\rangle >0\text{ und } \langle Ay,y\rangle <0\]
\end{definition}

\paragraph{Kriterien für positiv definite Matrizen}
Eine symmetrische relle $n\times n$ Matrix $A=(a_{ij})$ ist genau dann
positiv, wenn $\exists \alpha >0\,\forall x\in\R^n:\langle Ax,x\rangle \geq \alpha ||x||_2^2$
oder alle Eigenwerte von $A$ sind positiv, d.h. $\lambda >0$
oder $\forall k=1,\dots,n: \det\begin{pmatrix}a_{11}& \dots & a_{1k}\\
\vdots & & \vdots\\
a_{k1} & \dots & a_{kk}
\end{pmatrix}>0$\\
...
\begin{definition}
  ...
  definiert durch:
  \[(\text{Hess}f)(x):=\left(\frac{\partial^2 f}{\partial x_j \partial x_i}
  \right)_{i,j=1}^n\]
...
(x)\in D$ und alle $h \in\R^n$ mit $x+h\in B_\varepsilon(x): f(x+h)=f(x)
...
\begin{theorem}
  ...
  \begin{enumerate}[(i)]
    \item Ist $f''(x)=(\text{Hess }f)(x)$ positiv definit, so hat $f$ in
      ...
      Wählen $\delta>0:\forall h:||h||_2\leq \delta\Rightarrow|\rho(h)|
      \leq \frac{\alpha}{4}$. Damit erhält man für $0<||h||_2\leq \delta:
    ...
    \item Ist $f''(x)$ indefinit, so besitzt $f$ in $x$ kein lokales
      ...
      $x$ existieren $y', y'': f(y'')<f(x)<f(y')$. $f''(x)$ ist indefinit:
      $\exists \xi\in\R^n\backslash\{0\}:\langle f''(x)\xi,\xi\rangle =:\alpha>0$.
      ...
      <0$, so gilt für genügend kleine $|t|>0: f(x+t\eta)<f(x)$
  \end{enumerate}
  \qed
\end{theorem}
...
Setzen $\Delta:=\det f'' =\frac{\partial^2 f}{\partial x^2}\frac{\partial^2 f}{\partial y^2}
...
Sei $A=(a_{ij})_{\stackrel{i=1,\dots,m}{j=1,\dots,n}}:\R^n\rightarrow\R^m,
...
$g(x):=Ax-b, h(y):=||y||_2^2, g'(x)=A, h'(y)=\left(\frac{\partial h}{\partial y_1},
...
Eine Funktion $f:D\rightarrow\R^m,D\subset\R^n$ wird \emph{implizit\index{implizit}}
...
Funktionen $f_1,\dots,f_M:D\rightarrow\R$ zu bestimmen, dass gilt
$F_j(x_1,\dots,x_n,f_1(x_1,\dots,x_n),\dots,f(x_1,\dots,x_n))=0, 1\leq
j\leq m, \begin{pmatrix}x_1\\\vdots\\x_n
\end{pmatrix}\in D$

Beispiele: $n=m, F(x,y)=Ay-x, A:\R^n\rightarrow\R^n, F:\R^n\times\R^n
\rightarrow\R^n$\\
$F(x,y)=0\Leftrightarrow Ay-x=0\Leftrightarrow Ay=x$. Ist $A$ invertierbar,
so gilt $y=f(x)=A^{-1}x$
\begin{enumerate}[(a)]
  \item $m=n=1: F:\R\times\R\rightarrow\R, F(x,y)=y^3-x^2, F(x,y)=0
  ...
  \item $F:\R\times\R\rightarrow\R,F(x,y):=x^2+y^2-1=0$\\
...
\begin{align*}
  ...
  \end{pmatrix}& F:K\rightarrow\R^m\\
...
\begin{theorem}
  ...
  Sei $D\subset \R^n, G\subset\R^m$ offen und die Funktion $F:D\times G
  ...
  \begin{enumerate}[(i)]
    \item Es existiert eine offene $\delta$-Kugel $B_\delta(\xi)\subset
      ...
      G$ und genau eine stetige Funktion $f:_\delta(\xi)\rightarrow
    ...
    \item Es existiert eine weitere offene $\delta_1$-Kugel $B_{\delta_1}
      (\xi), \delta_1\leq \delta$ und die Funktion $f:B_{\delta_1}(\xi)
...
%Bild
\begin{align*}
  F(x,y) & = x^2+y^2-1 & F:\R\times\R\rightarrow\R\\
...
Problem: Unter welchen Bedingungen besitzt eine Funktion $f:D\rightarrow
\R^n, D\subset\R^n$, eine Umkehrung? Welche analytischen Eigenschaften
besitzt die Funktion $f^{-1}$?

$f(x)=Ax, A:\R^n\rightarrow\R^n, f(x)=Ax=y\rightarrow x=A^{-1}y,
f^{-1}(y)=A^{-1}y,f'(x)=A$

\begin{theorem}
  %II.4.2
  \label{satz:umkehrsatz}
  Sei $f:D\rightarrow\R^n, D\subset\R^n$ offen, stetig differenzierbar
  und in $\xi\in D$ sei $f'(\xi)$ invertierbar. Dann existiert eine
  offene Umgebung $U\in D$ von $\xi$ und eine $\varepsilon$-Kugel von
  $\eta=f(\xi)$, so dass $f|_U:U\rightarrow B_\varepsilon(\eta)$
  ...
  \textbf{Beweis}:
  $F:D\times\R^n\rightarrow\R^n, F(x,y):=f(x)-y=0$\\
  ...
  $\varphi :B_\varepsilon(\eta)\rightarrow B_\delta(\xi), \varphi(\eta)
  ...
  differenzierbar ist. Ferner gilt, da $f:D\rightarrow\R^n$ stetig ist,
  dass $f^{-1}(B_\varepsilon(\eta))$ offen in $\R^n$. Denn $x\in f^{-1}
  (B_\varepsilon(\eta))\stackrel{f \text{ stetig}}{\Rightarrow} \exists
  0<r<\infty:B_r(x)\cap D \subset f^{-1}(B_\varepsilon(\eta))
  \stackrel{D \text{ offen}}{\Rightarrow} \exists 0<r_0\leq r:B_{r_0}(x)
  \subset f^{-1}(B_\varepsilon(\eta))\Rightarrow f^{-1}(B_\varepsilon(\eta))$
  ist offen im $\R^n$.\\
  Für $U:=B_\delta(\xi)\cap f^{-1}(B_\varepsilon(\eta))=\{x\in B_\delta
  (\xi):f(x)\in B_\varepsilon(\eta)\}$ (offen) gilt $f(U)=B_\varepsilon(\eta)$.
  ...
  Injektivität: Seien $x_1,x_2\in U:f(x_1)=f(x_2)=y\Rightarrow F(x_1,y)=
  F(x_2,y)=0\stackrel{\text{Satz \ref{satz:implFunktion}}}{\Rightarrow}
  x_1=x_2$. Also ist $f|_U:u\rightarrow B_\varepsilon(\eta)$ von $U$ auf
...
Bemerkungen: 
\begin{enumerate}
  \item Sei $f:U\rightarrow V$ eine bijektive Abbildung der offenen
  ...
  \item Der Umkehrsatz ist eine "`lokale"' Aussage, d.h. existiert für
    eine stetig differenzierbare Funktion $f:D\rightarrow\R^n, f(x)^{-1}$,
    so existiert i.a. nicht die "`globale"' Inverse auf ganz $D$.\\
    Beispiel: $f:\R^2\rightarrow\R^2, f(x,y)=\begin{pmatrix}
      e^x\cos y\\e^x\sin y
    ...
    \end{pmatrix}, f'(x,y)^{-1}=\begin{pmatrix}
      ...
      -e^{-x}\sin y & e^{-x}\cos y
    \end{pmatrix}$\\
    Aber $f:\R^2\rightarrow\R^2$ ist nicht global invertierbar auf $\R^2$:
...
\begin{theorem}
  ...
  \begin{enumerate}[(i)]
    ...
    \item $a\neq\emptyset, y\in f(A)$ und $x\in A:f(x)=y$.\\
      ...
      \end{enumerate}
    \item Die Funktion $\varphi:D\rightarrow\R, \varphi(x):=||f(x)||$,
      besitzt kein Maximum und, falls $f(x)\neq 0$ in $D$, auch kein
      Minimum on $D$.\\
      Beweis: Annahme: $x_0\in D$ sei eine Maximalstelle von $\varphi$,
      d.h. $\forall x\in D:||f(x)||\leq ||f(x_0)||$. Dann ist $f(x_0)>0$.
    ...
    \item Ist $f$ injektiv, so ist $f^{-1}:f(D)\rightarrow\R$ stetig
      differenzierbar.\\
      Beweis: $f(D)$ ist nach (i) offen. Nach dem Umkehrsatz und da $f$
      injektiv ist, folgt $f^{-1}:f(D)\rightarrow\R^n$ ist stetig
      differenzierbar.
  \end{enumerate}
  \qed
\end{theorem}
...
Seien $f:X\rightarrow\R, X\subset\R^n$ offen und $g:X\rightarrow\R^m,
m<n$.\\
$f$ besitzt in $\xi\in X$ ein lokales Maximum bzw. lokales Minimum
unter der Nebenbedingung, $g(x)=0:\Leftrightarrow \xi\in N:=\{x\in X:
g(x)=0\}$ und es existiert ein $B_\delta(\xi)\subset X\,\forall x\in 
B_\delta(\xi)\cap N: f(x)\leq f(\xi)\text{ (lokales Maximum) bzw.}
...
\begin{theorem}
  %II.5.1
  \label{satz:lagrange}
  Sei $X\in\R^n$ eine offene Menge, $f:X\rightarrow\R, g:=\begin{pmatrix}
    g_1\\\vdots\\g_m
  \end{pmatrix}:X\rightarrow\R^m$ seien stetig differenzierbar und $f$
...
$\begin{pmatrix}
  ...
  h:B_\delta(\zeta)\rightarrow \R^m: h(\zeta)=\eta \wedge\forall
  z\in _\delta(\zeta): g(h(z),z)=0
  \end{equation}
  Ferner sei $\delta$ so klein, dass
  $\varphi(z):=f(h(z),z)$ differenzierbar ist. Es gilt:
...
$f:X\subset\R^n\rightarrow\R, g:X\rightarrow\R^m, m<n$\\
...
Aufgabe: Seien $f:X\subset\R^n\rightarrow \R, g=\begin{pmatrix}
  g_1\\\vdots\\g_m
\end{pmatrix}:X\rightarrow \R^m$. $f$ soll unter der Nebenbedingung
$g(x)=0$ extremal werden.

\paragraph{Merkregel:}
\begin{enumerate}
  \item Man bildet die Funktion $F:X\times\R^m\rightarrow\R, F(x,\lambda)
    :=f(x)+\lambda^Tg(x), x=\begin{pmatrix}x_1\\\vdots\\x_n
...
\begin{enumerate}[(i)]
  \item $N=\{x\in X:g(x)=0\}$. Ist $N$ kompakt, so besitzt die Funktion
  ...
  \item Seien $A,B\subset\R^n$ und $A\neq\emptyset$ ist kompakt und $B$ 
    ist abgeschlossen. Dann existiert $\xi\in A, \eta\in B:||\xi-\eta||
    =\inf_{\stackrel{x\in A}{y\in B}} ||x-y||$\\
    Die Kompaktheit der Menge ist notwendig, denn:\\
    $A=\{(t,\sqrt{t^2-1}:1\leq t\leq\infty\}, \not\exists \xi\in A,
    \eta\in B:||\xi-\eta||=\inf_{\stackrel{x\in A}{y\in B}} ||x-y||$
\end{enumerate}
...
\item Bestimme Minima und Maxima der Funktion $f(x,y,z)=5x+y-3z$ unter
  ...
  Eine zweireihige Unterdeterminante von $g'$ auf $N$ ist $\neq 0$.\\
    ...
    4+2\nu x & = & 0\\
    2\nu y & = & 0
  \end{array}\right\}\Rightarrow \nu\neq 0, y=0\stackrel{\ref{4},\ref{5}}{\Rightarrow}
  \left.\begin{array}{rcl}
    x+z & = & 0\\
    x^2+y^2 & = & 1
  ...
  \begin{align*}
    N&=\left\{\begin{pmatrix}x\\y\\z\end{pmatrix}\in
      \R^3:\begin{matrix}x+y+z=0\\x^2+y^2+z^2=1 \end{matrix}\right\}\\
...
\item Man bestimme die Extrema der Funktion $f(x)=\sum_{i=1}^n a_ix_i$
  ...
  \end{pmatrix}\in\R^n:x_1,\dots,x_n>0\wedge\sum_{i=1}^n \frac{a_ib_i}{x_i}
  =1\}$\\
...
\begin{definition}
  ...
  Abbildung $f:I\rightarrow\R^n$, wobei $I\subset\R$ ein Intervall ist.
  Die Kurve $f$ heißt differenzierbar (bzw. stetig differenzierbar), 
  wenn $f$ differenzierbar (bzw. stetig differenzierbar) ist.
\end{definition}
\begin{definition}
  Sei $I\subset\R$ ein Intervall und $f:I\rightarrow\R^n$ eine
...
Bemerkung: Eine Kurve $f:I\rightarrow\R^n$ braucht nicht injektiv zu sein.
...
Beispiel: 
\begin{alignat*}{2}
  f&:\R\rightarrow\R^2 & f(t) & = \begin{pmatrix}t^2-1\\t^3-t
  \end{pmatrix}\\
  x & = t^2-1 & y & = t^3-t=t(t^2-1)\\
  y^2 & = t^2(t^2-1)^2=x^2+x^3 & f(\R) & = \left\{\begin{pmatrix}x\\y\end{pmatrix}\in\R^2:y^2=x^2+x^3\right\}\\
...
\begin{definition}
  ...
  Seien $f:I_1\rightarrow\R^n, g:I_2\rightarrow\R^n$ zwei reguläre Kurven.
...
\begin{definition}
  Sei $f:D\rightarrow\R, D\subset\R^n$. Die Menge 
 \[\text{graph }(f)=\left\{\begin{pmatrix}x\\f(x)
  \end{pmatrix}\in\R^{n+1}:x\in D\right\}\]
  heißt \emph{Fläche\index{Fläche}}
  im $\R^{n+1}$.
\end{definition}
\begin{definition}
  Sei $f:D\rightarrow\R, D\subset\R^n$ offen und differenzierbar. Die
  Menge $T:=\left\{\begin{pmatrix}x\\y
\end{pmatrix}\in\R^{n+1}:x\in\R^n, y=f(\xi)+f'(\xi)(x-\xi)\right\}$ heißt
...
\begin{enumerate}[(1)]
  ...
  \item Die Tangentialebene $T$ kann man sich im Punkt $(\xi, f(\xi))^T$
   ...
   g_i:T\rightarrow\R^{n+1}\qquad g_i(\xi_i)=(f(\xi))
 \end{gather*}
    ...
    &=& \left\{\begin{pmatrix}\xi\\f(\xi)\end{pmatrix}+\sum_{i=1}^n h_i g_i'(\xi): h=\begin{pmatrix}h_1\\\vdots\\h_n\end{pmatrix}\in\R^n\right\}\\
      &=& \left\{\begin{pmatrix}
        \xi+h\\
        f(\xi)+\sum_{i=1}^n h_i \frac{\partial f}{\partial x_1}(\xi)
      \end{pmatrix}:h\in\R^n\right\} \quad h_i=x_i-\xi_i
    \end{align*}
\end{enumerate}

\subsection{Niveauflächen}
\begin{definition}
  Sei $f:D\rightarrow\R, D\subset\R^n$. Dann heißt die Menge $\{x\in D:
...
\begin{theorem}
  Sei $f:D\rightarrow\R, D\subset\R^n$ offen, stetig differenzierbar und
  ...
  \end{pmatrix}$ und eine Umgebung $V$ von $\xi_n$ und $\varphi:
  U\rightarrow V$ mit
  \begin{enumerate}
...
\section{Einführung}
\begin{definition}
  Sei $G\subset\R\times\R^n, f:G\rightarrow \R^n$ stetig. Dann heißt
  \begin{equation}
    \label{def:Diffgl}
    y'=f(x,y)
  \end{equation}
...
\begin{enumerate}
  ...
  \item Implizite Gestalt eines DGL-Systems 1 Ordnung:
    \[F(x,y,y')=0\]
    \[F:G\subset\R\times\R^n\times\R^n\rightarrow\R^n \text{ stetig}\]
...
Beispiel: $y'=f(x), f:I\rightarrow\R^n$ stetig, $x_0\in I, \varphi(x_0)
=y_0$\\
Integration: $\varphi(x)=y_0+\int_{x_0}^x f(t)dt$\\
$\int_{x_0}^x f(t)dt := \begin{pmatrix}
  \int_{x_0}^x f_1(t)dt\\
  \vdots\\
  \int_{x_0}^x f_n(t)dt
\end{pmatrix}$
...
\begin{definition}
  $G\subset\R\times\R^n\times\dots\times\R^n, f:G\rightarrow\R^n$ stetig\\
  Dann heißt
  \begin{equation}
...
Man setzt $Y:=\begin{pmatrix}y_0\\y_1\\\vdots\\y_{k-1}
\end{pmatrix}\in(\R^n)^k$\\
$F(x,Y):=\begin{pmatrix}y_1\\\vdots\\y_{k-1}\\
  f(x,y_0,\dots,y_{k-1})
\end{pmatrix}$.
Dann gilt:
\begin{enumerate}[a)] 
  \item $\varphi$ ist eine Lösung von \ref{def:DiffglHoch} 
$\Rightarrow\Phi:=\begin{pmatrix}\varphi\\ \varphi'\\\vdots\\ \varphi^{(k-1)}
\end{pmatrix}$ ist eine Lösung von 
\begin{equation}
  \label{def:DiffglEin}
   Y'=F(x,Y)
\end{equation}
Denn: Sei $\varphi:I\rightarrow\R^n$ eine Lösung von \ref{def:DiffglHoch},
...
\end{align*}
  \item $\Phi$ ist eine Lösung von \ref{def:DiffglEin}. Dann ist $\varphi
    :=\varphi_0$ eine Lösung von \ref{def:DiffglEin}.\\
    Denn: Sei $\Phi$ eine Lösung von $Y'=F(x,Y)\Rightarrow \varphi_0'=
    \varphi_1 \dots$. Setze $\varphi:=\varphi_0\Rightarrow \varphi Y'=F(x,Y)Y'=F(x,Y)i_1=
...
Wir zeigen, $\exists C\in\R:\psi(x)=C\varphi_0(x)+\varphi_{\text{inh}}(x)$ und
setzen $h(x):=\psi(x)-\varphi_{\text{inh}}(x)$. Dann gilt $h'(x)=\psi'(x)
-\varphi_{\text{inh}}'(x)=a(x)\psi(x)+b(x)-(a(x)\varphi_{\text{inh}}(x)
b(x))=a(x)(\psi(x)-\varphi_{\text{inh}}(x))=a(x)h(x)\Rightarrow h(x)$
ist Lösung des homogenen DGL $y'=a(x)y$. Somit existiert ein $C\in\R :
...
\begin{enumerate}[(a)]
  \item Die inhomogene DGL $y'=f(\frac{y}{x})$\\
    Sei $I\subset\R$ ein Intervall, $f:I\rightarrow\R$ stetig, $G:=\{
    ...
    (f(x)-x)$. Dann gilt für $\varphi(x)=\psi (x)\quad x :\varphi'(x)
    ...
    \end{itemize}
  \item Die Differentialgleichung $y''=f(y), f:J\rightarrow\R$ stetig\\
    ...
    Physiker setzen dann: $U(y):=-\int_{y_0}^y f(t)dt\Leftrightarrow
...
Sei $\MM_n(\K):=\{A=\begin{pmatrix}
  a_{11}& \dots & a_{1n}\\
  \vdots & & \vdots\\
  a_{n1} & \dots & a_{nn}
\end{pmatrix}:a_{ij}\in\K\}$ die Menge aller $n\times n$-Matrizen.
Dann heißt 
\begin{equation}
  \label{def:lDGL}
...
\end{pmatrix}:I\rightarrow\R^n$ eine stetige Funktion. Dann heißt
\begin{equation}
  \label{def:DGLFunkt}
  y'=Ay+b(x)
\end{equation}
...
Bemerkungen: Die Funktion $f:\R\times\R^n\rightarrow\R^n, f(x,y):=Ay$
...
Beispiel: Sei $A\in\LL(\K^n,\K^n), e^A:=\sum_{k=0}^\infty \frac{A^k}{k!}$
...
Bemerkung: $\Phi(x)=e^{Ax}, \Phi:\R\rightarrow\LL(\K^n,\K^n), \Phi'(x)
=Ae^{Ax}=e^{Ax}A$\\
...
\begin{definition}
  ...
  (\varphi_1,\dots,\varphi_n):\R\rightarrow\mathfrak{M}_n(\K)$ heißt
  ...
  \begin{enumerate}[(1)]
    ...
    \item Die allgemeine Lösung von $y'=Ay$ ist $\varphi(x)=\Phi(x)c, c
      ...
      zeigen ist $\varphi(x)$ Lösung von $y'=Ay$, so exitiert $c\in\K^n:
...
\begin{theorem}
  ...
  \begin{enumerate}[(1)]
    ...
    \frac{x^{l-1}}{(l-1)!}Se_1)$\\
    $v_i=Se_i: \varphi_l(x)=e^{\lambda x}(v_l+xv_{l-1}+\cdots+
    \frac{x^{l-1}}{(l-1)!}v_1)$
    Es gilt 
    \begin{align*}
...
Dann gilt für $J:=S^{-1}AS$ die Formel $e^{Ax}S=Se^{Jx}$. Denn $J^2=
...
\begin{definition}
  Sei $G\subset\R\times\R^n, f:G\rightarrow\R^n$ stetig.
  \begin{enumerate}[(a)]
    \item $f$ genüge in $G$ einer \emph{Lipschitzbedingung\index{Lipschitzbedingung}}
      \[\exists L\geq 0\,\forall(x,y),(x,\tilde{y})\in G: ||f(x,y)-f(x,\tilde{y})||\leq L||y-\tilde{y}||\]
...
Sei $G\subset\R\times\R^n$ offen und $f:G\rightarrow\R^n, f=f(x,y),
...
Beweis: $(a,b)\in G:\exists r>0$, so dass $U:=\{(x,y)\in\R\times\R^n:
...
\end{pmatrix}$ auf $U$: $L:=\sup\{\left|\left|\frac{\partial f}{\partial y}
(x,y)\right|\right|:(x,y)\in U\}<\infty$.\\
Nach dem Mitelwertsatz %Satz II.3.2
gilt:
...
\begin{theorem}
  Sei $G\subset\R\times\R^n$ offen und $f:G\rightarrow\R^n$ stetig, die
  lokal einer Lipschitzbedingung genügt. Dann gilt, dass für alle $(a,c)
  \in G$ ein $\varepsilon>0$ existiert und genau eine Lösung $\varphi:
  ...
  \begin{enumerate}[1. Schr{i}tt]
    \item Raum der stetigen Funktionen\\
      ...
      $\mathcal{C}(I,\R^n):=\{\varphi:I\rightarrow\R^n:\varphi\text{ stetig}\},
      ||\varphi||:=\sup_{x\in I}||\varphi(x)||_2$. Der Raum $[\CC(I,\R^n),
      ||\cdot||]$ ist ein vollständiger normierter Raum. Sei $I_\varepsilon
      :=[a-\varepsilon,a+\varepsilon], \varepsilon>0$. Wählen $\varepsilon,r>0$
      so, dass $U=\{(x,y)\in I_\varepsilon\times\R^n: ||y-c||_2\leq r\}
      \subset G$ und $f$ auf $U$ einer Lipschitzbedingung genügt, d.h.
      $\exists L\geq 0\,\forall (x,y),(x,\tilde{y})\in U:||f(x,y)-f(x,
      \tilde{y})||_2\leq ||y-\tilde{y}||_2$. $U$ ist kompakt und $f$
      stetig auf $U$. Man setzt $B_r^\varepsilon(c):=\{\varphi\in\CC(
      I_\varepsilon,\R^n):||\varphi-c||\leq r\}$ (ist i.a. nicht kompakt).
    ...
    \item Kontrahierende Abbildung\\
      ...
      \[T:B_r^\varepsilon(c)\rightarrow\CC(I_\varepsilon,\R^n)\]
      durch den Ansatz $(T\varphi)(x):=c+\int_a^x
      f(t,\varphi(t))dt$.
      \begin{enumerate}
    ...
    & \leq & |x-a|M\leq \varepsilon M\quad \forall x\in I_\varepsilon
      \end{align*}
      Hieraus folgt: 
      \[\boxed{\forall \varphi\in B_r^\varepsilon(c):||T\varphi-
    ...
    B_r^\varepsilon(c):||T\varphi-T\tilde{\varphi}||\leq\varepsilon L
    ||\varphi-\tilde{\varphi}||}\]
    \end{enumerate}
    ...
    \begin{enumerate}
      ...
      \item $\forall \varphi,\tilde{\varphi}\in B_r^\varepsilon(c):
    ||T\varphi-T\tilde{\varphi}||\leq \frac{1}{2}||\varphi-\tilde{\varphi}||$
    \end{enumerate}
  \item Anwendung des Banachschen Fixpunktsatzes\\
    Man setzt $X:=B_r^\varepsilon(c)$ (vollständiger metrischer Raum)
    und $T:X\rightarrow X$ ist kontrahierend. Nach dem Banachschen
    Fixpunktsatzes existiert genau ein $\varphi\in X=B_r^\varepsilon(c):
    T\varphi=\varphi$.
  \end{enumerate}
...
\begin{enumerate}[(a)]
  \item $y'=\sqrt[3]{y^2}, y=\varphi(a)=c, f=f(x,y)=\sqrt[3]{y^2}, f:
...
\begin{theorem}
  %Satz III.5.1.1
  Sei $I\subset\R$ ein offenes Intervall und $A:I\rightarrow\MM_n(\K), b:
  I\rightarrow\K^n$ stetige Abbildungen. Dann gilt: 
  \[\forall x_n\in I\,\forall c\in\K^n\,\exists^1 \text{Lösung }
  \varphi:I\rightarrow\K^n: y'=A(x)y+b(x), \varphi(x_0)=c\]
  ...
  \forall y,\tilde{y}\in\K^n: ||f(x,y)-f(x,\tilde{y})||\leq
  L||y-\tilde{y}||$\\
  $A(x)=(a_{ij}(x))$ ist stetig. Daher ist auch $a_{ij}(x)$ stetig. Aus
  der Tatsache, dass $J$ kompakt ist, folgt $M_J:=\max_{i,j=1,\dots,n}
...
Dazu wird $\LL_h$ für homogene Lösungen eingeführt: $\LL_h:=\{\varphi:I
\rightarrow\K^n: \varphi \text{Lösung von } y'=A(x)y\}$\\
$\LL_{inh}:=\{\varphi:I\rightarrow\K^n: \varphi \text{Lösung von } y'=A(x)
y+b(x)\}$
...
\begin{definition}
  \begin{enumerate}[(i)]
    ...
    \item $k$ stetige Funktionen $\varphi_1,\dots,\varphi_k\in\CC(I,\K^n)$
      ...
      \[\exists\alpha_1,\dots,\alpha_k\in\K:\sum_{i=1}^k \alpha_i\varphi_i
      =0\wedge\sum_{i=1}^k|\alpha_i|>0\]
  \end{enumerate}
\end{definition}

Bemerkung: $\sum_{i=1}^k \alpha_i\varphi_i=0:\forall x \in I: \sum_{i=1}^k
...
\begin{theorem}
  ...
  \begin{enumerate}[(a)]
    ...
    \item $\varphi_1,\dots,\varphi_k$ sind linear unabhängig über
      $\K$.
    \item $\exists x_0\in I:\varphi_1(x_0),\dots,\varphi_k(x_0)\in
      \K^n$ sind linear unabhängige Vektoren über $\K$.
    \item $\forall x\in I: \varphi_1(x),\dots,\varphi_k(x)\in\K^n$
      ...
      \in\LL_h$. Annahme: $\exists x_0\in I: \varphi_1(x_0),\dots,
      \varphi_k(x_0)$ sind linear abhängig, d.h. $\exists\alpha_1,\dots,
      \alpha_k\in\K:\sum_{i=1}^k |\alpha_i|>0\wedge \sum_{i=1}^k \alpha_i
      ...
      $\varphi=0$ ist die einzige Lösung des AWP, d.h. $\forall x\in I:
...
\begin{enumerate}[(a)]
  \item Nach Satz \ref{satz:linAbh} gilt: $\varphi_1,\dots,\varphi_n$
    linear unabhängig, g.d.w. $\exists x_0\in I:\det\Phi(x_0)\neq
    0\Leftrightarrow\forall x \in I:\det \Phi(x)\neq 0$
...
\begin{theorem}
  Sei $I\subset\R$ ein offenes Intervall und $A:I\rightarrow\MM_n(\K),
  b:I\rightarrow\K^n$ stetig. Dann gilt für $\psi_0\in\LL_{inh}:\LL_{inh}
  =\psi_0+\LL_h:=\{\psi_0+\varphi:\varphi\in\LL_j\}$, d.h. $\psi(x)=\psi_0
  ...
  \begin{enumerate}[1. Schr{i}tt]
    \item Zu zeigen ist $\LL_{inh}\subset\psi_0+\LL_h$. Sei $\psi\in\LL_{inh}$.
      ...
      \Rightarrow\exists\varphi\in\LL_h:\psi-\psi_0=\varphi$.
    \item Zu zeigen ist $\psi_0+\LL_h\subset\LL_{inh}$. Sei $\psi\in\psi_0
      +\LL_h$, d.h. $\exists\varphi\in\LL_h:\psi=\psi_0+\varphi
...
$y'=A(x)y$. Dann gilt für die allgemeine Lösung von $y'=A(x)y:\varphi(x)
=\Phi(x), c\in\K^n$.\\
...
\end{align*}
$\alpha=1: \varphi_1(x)=(1,x)^T$ und $\alpha=\frac{1}{2}:\varphi_2(x)=
...
$L(y):=y^{(n)}+a_{n-1}(x)y^{(n-1)}+\cdots+a_1(x)y'+a_0(x)y=f(x)$ 
...
\begin{theorem}
  \begin{enumerate}[(i)]
    \item Sei $\LL_h:=\{\varphi:I\rightarrow \K:L(\varphi)=0\}$ die Menge
      der Lösungen des homogenen DGL. Dann ist $\dim \LL_h=n$
    \item Sei $\LL_{inh}:=\{\varphi:I\rightarrow\K:L(\varphi)=f(x)\}$
      die Menge der Lösungen der inhomogenen DGL. Dann gilt für ein 
      $\psi_0\in\LL_{inh}:\LL_{inh}=\psi_0+\LL_h$.
    \item $n$-Lösungen $\varphi_1,\dots,\varphi_n\in\LL_h$ der homogenen
      DGL sind genau dann linear unabhängig, wenn $\exists x_0\in I:
      W(x)\footnote{heißt Wronskideterminante\index{Wronskideterminante}}:=\det\begin{pmatrix}
	\varphi_1(x) & \dots & \varphi_n(x)\\
	\varphi_1'(x) & & \varphi_n'(x)\\
	\vdots & & \vdots\\
	\varphi_1^{(n-1)}(x) & \dots & \varphi_n^{(n-1)}(x)
      \end{pmatrix}\neq 0\Leftrightarrow \forall x \in I:W(x)\neq 0$
  \end{enumerate}
  \textbf{Beweis}: Die DGL $L(y)=f(x)$ ist äquivalent zu dem inhomogenen
  DGL-System 1.~Ordnung $y_0:=y$.
  \begin{alignat*}{2}
    y_0' & = y_1 & y_0' & = y_1\\
    y_1' & = y_2 & y_0''& =y_2\\
    \vdots & & \vdots\\
  ...
  \end{alignat*}
  Jeder Lösung $\varphi:I\rightarrow\K$ von $L(y)=f(x)$ entspricht einer
  Lösung $y=\begin{pmatrix}y_0\\y_1\\\vdots\\y_{n-1}
  \end{pmatrix}=\begin{pmatrix}\varphi\\ \varphi'\\\vdots\varphi^{(n-1)}
  \end{pmatrix}:I\rightarrow\K^n$ des Systems oben. Damit folgen die
...
\begin{definition}
  ...
  Also: Allgemeine Lösung von $L(y)=0: \varphi(x)=c_1\varphi_1(x)+
...
\begin{enumerate}[1. Schr{i}tt]
  ...
  \item Berechnung der $c_i'(x)$ mit Cramerscher Regel\\
    ...
    Spezielle Lösung von $L(y)=f(x): \psi_0(x)=\sum_{i=1}^n c_i(x)
...
+a(x)\right)u'=0$. Setzen $v:=u'$. Dann ist
\begin{equation}
  \label{eq:Redv}
...
\begin{theorem}
  Besitzt das Polynom $P_L(\lambda):=\lambda^n+a_{n-1}\lambda^{n-1}+\cdots+
  ...
  \[\varphi_{km}(x):=x^me^{\lambda_kx}\quad m=0,1,\dots,n_k-1\quad k=1,\dots,s\]
\end{theorem}
\begin{proof}
  \begin{enumerate}[1. Schr{i}tt]
  \item Man zeigt, dass $\varphi_{km}(x)=x^me^{\lambda_kx}$ 
    Lösungen von $L(y)=0$ sind.\\
    Ansatz: $\varphi(x):=e^{\lambda x}$. Dann gilt $\varphi^{(k)}(x)=
    \lambda^ke^{\lambda x}$.
    \[L(\varphi(x))=(\lambda^n+a_{n-1}\lambda^{n-1}+\cdots+a_1\lambda
    +a_0)e^{'\lambda x}=0\]
    Die obige Gleichung ist genau dann 0, wenn 
    \[P_L(\lambda):=\lambda^n+a_{n-1}\lambda^{n-1}+\cdots+a_1\lambda
  ...
  \item Die $\varphi_{km}(x)=x^me^{\lambda_k x}, m=0,1,\dots,n_k-1,n=
    ...
    \begin{lemma}
      ...
      P_1=P_2=\cdots=P_r=0\] Beweis durch Induktion: $r=1:
...
\begin{enumerate}[1. F{a}ll]
  \item $0\leq \mu<\omega_0: \lambda_{1,2}=-\mu\pm i\omega, \omega=
...
\item $\mu>\omega_0$: Dann ist $\lambda_1=-+\sqrt{\mu^2-\omega_0^2}, 
  \lambda_2=-\mu-\sqrt{\mu_2-\omega_0^2}<0$. Man setzt: $\mu_j:=-\lambda_j
...
\begin{theorem}
  %Satz IV.3.1
  Sei $G\subset\R^n$ ein Gebiet\index{Gebiet} und $f:G\rightarrow\R^n$
  ein Gradientenfeld. Dann erhält man alle Skalarfelder 
  (Stammfunktionen) $\Phi:G\rightarrow\R$ von $f$, d.h. $f=\text{ grad}
  \Phi$, in der Form
...
\begin{theorem}
  %VI.3.2
  Sei $G\subset\R^n$ ein Gebiet und $f:G\rightarrow\R^n$ ein stetiges
  ...
  \begin{itemize}
    \item["`$\Rightarrow$"'] Sei $f=\text{ grad}\Phi=\Phi'$. Seien 
      ...
      Weg $\gamma:[a,b]\rightarrow\R^n$ mit $\gamma(a)=A$ und $\gamma(b)=
    ...
    \item["`$\Leftarrow$"'] Sei $\xi\in G$ und $B_\varepsilon(\xi)\subset
      ...
      (\xi)$ für $0\leq t\leq 1$. Setzen $\Phi(x):=\int_A^x f(y)dy, A\in G$
      ...
      =|\int_\sigma f(y)-f(\xi))dy|\leq \max_{y\in \{\xi+th:0\leq t\leq 1}
      ||f(y)-f(\xi)||_2 L(\sigma)$. Da $f$ stetig ist, folgt $\max_{y\in \{\xi+th:0\leq t\leq 1}
...
\begin{enumerate}[(i)]
  \item Notwendiges Kriterium\\
    ...
    \begin{pmatrix}
      f_1\\\cdots\\f_n
    \end{pmatrix}:G\rightarrow\R^n$ ein stetig differenzierbares
    ...
    Beweis: (Schwatzscher Satz): $f=\text{ grad }\Phi=\Phi'$, da $f$
  ...
  \item Hinreichende Bedingungen\\
    ...
    d.h. $\exists a \in G\,\forall x \in G\,\forall t\in[0,1]:a+tx\in G$,
    und $f=
    \begin{pmatrix}
      f_1\\\cdots\\f_n
    \end{pmatrix}:G\rightarrow\R^n$ ein stetig differenzierbares
    Vektorfeld mit $\frac{\partial f_j}{\partial x_k}=\frac{\partial f_k}{\partial x_j},
    j,k=1,\dots,n$. Dann ist $f$ ein Gradientenfeld, d.h. $\exists\Phi:
    G\rightarrow\R:f=\text{ grad }\Phi$.\\
