...
viele reelle Zahlen als Ergebnis auftreten können (z.\,B. Lebenszeiten,
Messwerte etc.).
...
\begin{center}
  ...
  \begin{tabular}{@{}l@{\qquad}l@{}}
    \toprule
    \multicolumn{1}{@{}c@{\qquad}}{\textbf{Verteilung}}
       & \multicolumn{1}{@{\qquad}c@{\qquad}}{\textbf{Erwartungswert}}\\
    \midrule
...
\begin{center}
  ...
  \begin{tabular}{@{}l@{\qquad}l@{}}
    \toprule
    \multicolumn{1}{@{}c@{\qquad}}{\textbf{Verteilung}}
       & \multicolumn{1}{@{\qquad}c@{\qquad}}{\textbf{Varianz}}\\
    \midrule
    $X$ gleichverteilt auf $x_1,\dotsc,x_N$
