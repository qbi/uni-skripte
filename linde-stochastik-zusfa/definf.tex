...
\end{gather*}
heißt \highl{Gleichverteilung} auf $\{\omega_1,\ldots,\omega_N\}$. Für ein Ereignis $A$ gilt dann
\begin{gather*}
...
\begin{gather*}
  E_\lambda([\alpha,\beta])=\lambda \int_\alpha^\beta \ez^{-\lambda x}\,\mathrm dx
...
Funktion
\begin{gather*}
  p_{\mu,\sigma^2}(x):= \frac{1}{\sqrt{2\pi}\sigma}\,\ez^{-(x-\mu)^2/2\sigma^2}\;,
     \quad x\in\R\;,
\end{gather*}
...
\begin{gather*}
  \mathcal N(\mu,\sigma^2)([\alpha,\beta])=\frac{1}{\sqrt{2\pi}\sigma}
     \int_\alpha^\beta \ez^{-(x-\mu)^2/2\sigma^2}\mathrm dx\;.
\end{gather*}
...
\begin{gather*}
  \mathcal N(0,1)([\alpha,\beta])=\frac{1}{\sqrt{2\pi}}
     \int_\alpha^\beta \ez^{-x^2/2}\mathrm dx\;.
\end{gather*}
...
Die Ereignisse $A_1,\ldots,A_n$ aus $\Algeb$ heißen (stochastisch) \highl{unabhängig},
...
\end{gather}
Die Ereignisse $A_1,\ldots,A_n$ aus $\Algeb$ heißen \highl[unabhängig!paarweise]{paarweise unabhängig}, wenn
...
\begin{gather*}
  \WKM_X([\alpha,\beta])=\WKM\{\omega\in \Omega \colon \alpha\le X(\omega)\le \beta\}=
     \frac{1}{\sqrt{2\pi}\sigma}\int_\alpha^\beta \ez^{-(x-\mu)^2/2\sigma^2}\mathrm d x\;.
\end{gather*}
...
\begin{gather*}
  \int_{-\infty}^\infty \abs{x}\,p(x)\,\mathrm   d x <\infty\;,
\end{gather*}
...
und im stetigen
\begin{gather*}
  \int_{-\infty}^\infty \abs{x}^n\,p(x)\,\mathrm d x<\infty\;.
\end{gather*}
...
ergibt sich die Kovarianz von $X$ und $Y$ aus
  \begin{gather*}
    \cov(X,Y)=\int_{-\infty}^\infty \int_{-\infty}^\infty (x-a)(y-b)\,p(x,y)\,\mathrm d x\, \mathrm d y\;.
  \end{gather*}
\item
...
\begin{gather}
\label{cov}
\abs{\cov(X,Y)}\le (\V X)^{1/2}(\V Y)^{1/2}\;.
\end{gather}
...
\highl[Korrelationskoeffizient]{Korrelationskoeffizienten} durch
  \begin{gather*}
    \rho(X,Y):=\frac{\cov(X,Y)}{(\V X)^{1/2}(\V Y)^{1/2}}\;.
  \end{gather*}
Aus (\ref{cov}) folgt
  \begin{gather*}
    -1\le \rho(X,Y)\le 1\;.
