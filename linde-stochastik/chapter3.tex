...
\subsubsection*{Anwendung}
	...
	\[r_n:=\frac{\Y_1,\ldots,\Y_n}{n}\quad\text{rel. Häufigkeit des Eintretens
	...
	%	$\to 1-\p(0.15\overline{6}\leq r_n\leq 0.17\overline{6}=$ %was kommt da hin?
	%\end{Bsp}
	...
	\begin{enumerate}
		\item{Würfel n mal,$a=\frac{7}{2},\quad\sigma^2=\frac{35}{12}$\\
		 ...
		 \item{Rechnungen bei Banken\\
			...
			2 Euro $\approx 0.149349$\\
			$\vdots$\\
			10 Euro $\approx 0.00026603$\\}
