...
\end{center}
{\footnotesize 
{\bf Bedienzeit }\ldots Dauer der Ausführung\\
{\bf Wartezeit }\ldots Dauer des Aufenthalts in der Warteschlange\\
{\bf Verweilzeit}\ldots Verzögerungszeit, Latenz, Antwortzeit}\\
...
überlebt. Es gilt:
\begin{center}
	$R(0)=1 \longrightarrow$ Das Gerät ist zum Zeitpunkt 0 funktionstüchtig.
\end{center}
\begin{center}
	$R(\infty)=0\longrightarrow$ Nach genügend langer Zeit fällt das Gerät aus.
\end{center}
...
die Früausfälle durch die Technik des \emph{burn in} lokalisieren und
